...
export const GLOSSARY: Record<string, string> = {
    // Overview metrics
    runArtifacts: "Number of run JSON artifacts loaded from the runs directory.",
    benchmarkArtifacts: "Number of benchmark JSON artifacts (grouped runs by question).",
    skippedFiles: "Number of files skipped during analysis (e.g. invalid or excluded).",
    ...
    // Benchmark metrics
    modeCount: "Number of distinct answer clusters discovered from benchmark final-answer embeddings.",
    divergenceEntropy:
        "Entropy of run distribution across modes; higher means broader divergence.",
    entropy: "Entropy of run distribution across modes; higher means broader divergence.",
    ...
    zScore:
        "How unusual a run is vs peers; more negative = stronger outlier behavior.",
    modeStructure:
    ...
    // Run compare metrics
    stepCount: "Number of pipeline steps; reflects pipeline depth and additional critique passes.",
    ...
    cfModeCount: "Number of counterfactual failure modes identified for this run.",
    topCounterfactualMode: "Most frequent failure mode identified by CounterfactualAgent.",
    ...
    judgement: "Quality judgement with rubric scores (coherence, completeness, factual risk).",
    evidence_plan: "Evidence requirements, verification checks, and risk assessment.",
